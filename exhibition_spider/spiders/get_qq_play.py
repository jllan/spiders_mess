...
def get_items(sid, current_date):
    items = []
    url = 'http://cgi.yanchu.qq.com/cgi-bin/yanchu/mb_api/jsondata.fcg?g_tk=4d3754f563ad04a56fece81bbcc83302&cbk=callback&sCmd=citytype&IDS=0%2C4&page=0&_=1444293087486'
    data = get_data(url,  str(1))
    if data and data['data']['page_data']:
        print data['data']['page_data']
        pages = int(data['data']['page_tol'])
        print '共%s页'%pages
        for page in range(pages):
            url = 'http://cgi.yanchu.qq.com/cgi-bin/yanchu/mb_api/jsondata.fcg?g_tk=4d3754f563ad04a56fece81bbcc83302&cbk=callback&sCmd=citytype&IDS=0%2C4&page='+str(page)+'&_=1444293087486'
